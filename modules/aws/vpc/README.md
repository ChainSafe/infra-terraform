...
| <a name="input_transit_gw_owner"></a> [transit\_gw\_owner](#input\_transit\_gw\_owner) | ID Of the account containing TGW (defaults null)<br/><br/>Example:<br/>* transit\_gw\_owner = "1234567890" | `string` | `null` | no |
